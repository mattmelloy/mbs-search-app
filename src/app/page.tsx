...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-2xl mx-auto bg-white dark:bg-slate-800 p-6 shadow-md rounded-lg">
        <form onSubmit={handleSearch} className="space-y-4">
          <div>
            <label htmlFor="searchQuery" className="block text-sm font-medium text-gray-700 dark:text-slate-300">
            ...
            <div className="mt-1 flex rounded-md shadow-sm">
              <input
                ...
                className="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-l-md sm:text-sm border-gray-300 dark:border-slate-600 px-3 py-2 dark:bg-slate-700 dark:text-slate-200 dark:placeholder-slate-400"
                placeholder="Enter item code or keywords"
              />
              <button
                type="submit"
                disabled={isLoading}
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-r-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 dark:bg-indigo-500 dark:hover:bg-indigo-600"
              >
